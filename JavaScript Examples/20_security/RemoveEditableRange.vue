<template>
  <span>Click the following button to remove the editable range of the document</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "RemoveEditableRange.docx";
        ...
        const outputFileName = "RemoveEditableRange.docx";
