<template>
  <span>Click the following button to add a picture to table cell in a Word document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputImgFileName = "Spire.Doc.png";
        ...
        const outputFileName = "AddPictureToTableCell_output.docx";
