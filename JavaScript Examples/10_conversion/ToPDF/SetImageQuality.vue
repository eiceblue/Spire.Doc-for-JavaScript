<template>
  <span>The example shows how to set image quality during Doc to PDF conversion.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "SetImageQuality.doc";
        ...
        const outputFileName = "SetImageQuality-result.pdf";
