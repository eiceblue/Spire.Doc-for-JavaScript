<template>
  <span>Click the following button to insert page ref field in a Word document</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "PageRef.docx";
        ...
        const outputFileName = "InsertPageRefField.docx";
