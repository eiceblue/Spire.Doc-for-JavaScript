<template>
  <span>Click the following button to remove custom property fields in Word document</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "RemoveCustomPropertyFields.docx";
        ...
        const outputFileName = "RemoveCustomPropertyFields_out.docx";
