<template>
  <span>Click the following button to get form field by name</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        sb.push("The name of the form field is " + name + "\n");
        sb.push("The type of the form field is " + formField.FormFieldType + "\n");

        // Combine all the found data into a single string
        let content = sb.join("");

        // Define the output file name
        const outputFileName = "GetFormFieldByName.txt";
