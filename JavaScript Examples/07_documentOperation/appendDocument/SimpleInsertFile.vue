<template>
  <span>Click the following button to insert Word file in a simple way.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName1 = "Template_N5.docx";
        ...
        const outputFileName = "SimpleInsertFile_out.docx";
