<template>
  <span>The following example demonstrates how to replace text by regex in a Word document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = 'ReplaceTextByRegex.docx';
        ...
        const outputFileName = 'ReplaceTextByRegex.docx';
